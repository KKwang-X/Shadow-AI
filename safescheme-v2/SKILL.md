---
name: safescheme-v2
description: SafeConfig v2.1 - 不可绕过的强制配置安全管理流程。基于 OpenClaw Scheme 规范的完整安全配置管理，包含 9 Phase 强制流程（预审查→备份→审批→虚拟测试→变更→验证→审计）、16 项验证、虚拟环境测试、审计追踪、自动回滚。
version: 2.1.0
author: KKwang-X
license: MIT
